...
$(function () {
  $('#datepicker').datepicker({
    showOn: 'button',
    buttonImage: 'calendar.png', // File (and file path) for the calendar image
...
function dayTripper() {
  $('.ui-datepicker-trigger').click(function () {
    setTimeout(function () {
      var titleID = generateUniqueID();
      $('.ui-datepicker-title').attr('id', titleID);
      $('.ui-datepicker-calendar').attr('aria-labelledby', titleID);
...
function setHighlightState(newHighlight, container) {
  ...
  var oldLabel = $(prevHighlight).attr('aria-label') || '';
  var newLabel = oldLabel.replace(' (Selected)', '');
  $(prevHighlight).attr('aria-label', newLabel);
